...
(define tests
  (test-suite "a8"
    (test-suite "ack-tramp-driver"
      (test-equal-if-defined ack-tramp-driver
        ((ack-tramp-driver 2 3) 9)))
    (test-suite "depth-tramp-driver"
      (test-equal-if-defined depth-tramp-driver
        ((depth-tramp-driver '((((a) b (c (d))) e))) 5)))
    (test-suite "fact-tramp-driver"
      (test-equal-if-defined fact-tramp-driver
        ((fact-tramp-driver 3) 6)))
    (test-suite "pascal-tramp-driver"
      (test-equal-if-defined pascal-tramp-driver
        ((pascal-tramp-driver 10) '(1 3 6 10 15 21 28 36 45 55))))
